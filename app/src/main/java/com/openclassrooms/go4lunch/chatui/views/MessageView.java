package com.openclassrooms.go4lunch.chatui.views;
...
public abstract class MessageView extends FrameLayout {
    ...
    private Space space;
    /*private ConstraintLayout constraintButt;
    ...
    /*public void setVisibleButtOn() {
        ...
        this.constraintButt = findViewById(R.id.constraintButt);

        space.setVisibility(View.VISIBLE);
        constraintButt.setVisibility(VISIBLE);
    }

    public void setVisibleButtOff() {
        this.space = findViewById(R.id.space);
        this.constraintButt = findViewById(R.id.constraintButt);

        space.setVisibility(GONE);
        constraintButt.setVisibility(GONE);
    }*/
