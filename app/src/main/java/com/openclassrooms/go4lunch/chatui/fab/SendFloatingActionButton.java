package com.openclassrooms.go4lunch.chatui.fab;
...
public class SendFloatingActionButton extends FloatingActionButton {
    ...
    public boolean isMicButton() {
        return isMicButton;
    }

    public void setMicButton(boolean micButton) {
        isMicButton = micButton;
    }
}
